        ...
        <div class="row">
            <div class="col">
                <?php
                    ...
                    $sql = "INSERT INTO emprestimo (vencimento,descricao,receita,despesa,categoria,carteira,pago) VALUES ('$vencimento','$descricao','$receita','$despesa','$categoria','$carteira','$pago')";
                    ...
                    if(mysqli_affected_rows($conexao)){
                        ...
                        <a type='button' class='btn btn-outline-warning' href='emprestimo.php'>Novo Emprestimo</a></div>";

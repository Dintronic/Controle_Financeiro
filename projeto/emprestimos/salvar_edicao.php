        ...
        <div class="row">
            <div class="col">
                ...
                <?php
                    ...
                    $sql = "UPDATE emprestimo SET vencimento='$vencimento', descricao='$descricao', receita='$receita', despesa='$despesa', categoria='$categoria', carteira='$carteira', pago='$pago' WHERE id='$id'";

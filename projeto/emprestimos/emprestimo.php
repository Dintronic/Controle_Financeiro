    ...
    <div class="container">
        ...
        <form method="post" action="salvar.php">
            ...
            <div class="row"> 
                ...
                <div class="col-5">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text col-3" id="addon-wrapping">Entrada:</span>
                        <input type="number" step=".01" class="form-control" aria-label="Username" aria-describedby="addon-wrapping" name="receita">
                    </div>
                </div>
            </div><br>
            ...
            <div class="row"> 
                ...
                <div class="col-5">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text col-3" id="addon-wrapping">Saída:</span>
                        <input type="number" step=".01" class="form-control" aria-label="Username" aria-describedby="addon-wrapping" name="despesa">
                    </div>
                </div>
            </div><br>

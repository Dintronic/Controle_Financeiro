...
$result_usuario = "SELECT * FROM pagamentos WHERE id = '$id'";
            ...
            <div class="row"> 
                ...
                <div class="col-5">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type='number' step='.01' class='form-control' aria-label='Username' name='despesa' aria-describedby='addon-wrapping' value="<?php echo $row_usuario['despesa']; ?>">
